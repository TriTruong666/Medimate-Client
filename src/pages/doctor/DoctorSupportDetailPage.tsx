    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4 backdrop-blur-sm">
        ...
        <motion.div
          ...
          className="z-10 flex h-[90vh] max-h-215 min-h-0 w-full max-w-5xl flex-col overflow-hidden rounded-2xl border border-white/10 bg-neutral-900/80 shadow-2xl backdrop-blur-xl"
        >
                ...
                <section className="rounded-2xl border border-white/10 bg-white/5 p-5">
                  <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                    ...
                    <div className="grid gap-2 text-sm text-gray-300 md:text-right">
                      <div className="flex items-center gap-2 md:justify-end">
                        ...
                        <span className="rounded-md bg-blue-500/20 px-2 py-0.5 font-medium text-blue-400">
                  ...
                  {data.cancelReason?.trim() ? (
                    <div className="mt-4 rounded-xl border border-yellow-500/20 bg-yellow-500/5 p-4">
                      <p className="text-xs font-semibold tracking-wide text-yellow-300 uppercase">
                        Lý do hủy / ghi chú
                      </p>
