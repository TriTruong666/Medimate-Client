      ...
      <div className="flex items-center justify-between border-t border-gray-400 bg-white/5 p-6 shadow-sm dark:border-white/10">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="bg-primary rounded-lg px-6 py-2 text-sm font-bold text-white shadow-lg transition hover:opacity-90 disabled:bg-gray-200 disabled:text-gray-400 dark:disabled:bg-white/10 dark:disabled:text-white/40 active:scale-95"
          >
